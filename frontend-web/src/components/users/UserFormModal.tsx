...
interface Props {
    ...
    onSuccess: (user: User) => void; // callback al guardar
}
...
export function UserFormModal({ user, onClose, onSuccess }: Props) {
    ...
    // Si cambia el usuario (ej. abren editar otro usuario), sincronizar los campos
    useEffect(() => {
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        try {
            ...
            onSuccess(result); // Notifica al padre para actualizar la lista
            onClose();
        } catch (err: any) {
    ...
    return (
        ...
        <div
            ...
            onClick={onClose}
        >
            {/* Contenedor del modal — stopPropagation evita que el click dentro cierre el modal */}
            <div
